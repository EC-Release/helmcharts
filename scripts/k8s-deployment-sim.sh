...
kubectl delete --all deployments && kubectl delete --all pods && kubectl delete --all services && kubectl delete --all ingresses && kubectl delete --all persistentvolumes && kubectl delete --all persistentvolumeclaims
